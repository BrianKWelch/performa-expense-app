...
from per_diem import calculate_per_diem_total
...
def generate_excel(
    ...
    return_date,
    purpose: str,
    per_diem_first_last_rate: float,
    per_diem_middle_rate: float,
    per_diem_days: int,
    expenses: list[dict]
) -> io.BytesIO:
    wb = Workbook()
    ...
    per_diem_total = calculate_per_diem_total(
        per_diem_days,
    ...
    # Per diem
    ws["A11"] = "Per Diem First/Last Day Rate"
    ws["B11"] = per_diem_first_last_rate
    ws["A12"] = "Per Diem Middle Day Rate"
    ws["B12"] = per_diem_middle_rate
    ws["A13"] = "Per Diem Days"
    ws["B13"] = per_diem_days
    ws["A14"] = "Per Diem Total"
    ws["B14"] = per_diem_total
